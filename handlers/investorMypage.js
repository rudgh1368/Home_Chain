var investorMypage = function (params, callback) {
    console.log("JSON-RPC investorMypage 호출");
    console.log(params[0].password);

    var database = req.app.get('database');

    if (database.db){
        database.UserModel.findRole2(params[0].user.id, function(err, results_user) {
            if (err) {
